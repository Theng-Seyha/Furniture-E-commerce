...
export const SummerDealBanner = ({ onGrabDeal }) => {
  ...
  return <section className="py-8 sm:py-12" id="summer-deal">
  ...
  >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-200/80 dark:bg-amber-950/80 text-amber-900 dark:text-amber-300 text-xs font-semibold self-start mb-4">
                ...
                <span>Student Studio Batch</span>
              </div>

              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-stone-900 dark:text-stone-50 leading-[1.15]">
              ...
              <p className="mt-4 text-sm sm:text-base text-stone-600 dark:text-stone-300 font-normal max-w-md">
                We just finished our seasonal timber run of solid oak tables and lounge chairs. Use code <span className="font-semibold text-stone-800 dark:text-stone-100">SUMMER25</span> to take 25% off while timber stocks last.
              </p>
