...
export const Newsletter = () => {
  ...
  return <section className="py-14 sm:py-20" id="newsletter">
  ...
  >
                ...
                </motion.div> : <form onSubmit={handleSubscribe} className="mt-6 flex flex-col sm:flex-row gap-3 max-w-md">
